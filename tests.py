...
class TestBooksCollector:
    ...
    # Проверяем добавление 2 новых книг
    ...
    #  Проверяем валидные длины названия книги c параметризацией
    ...
    def test_add_new_book_name_length(self, book_name):
     ...
     # Проверяем установленный жанр книги
    ...
    #  Проверяем выведение списка книг определённого жанра
    ...
    # Провевяем получение списка избранных книг
